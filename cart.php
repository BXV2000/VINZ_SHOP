                ...
                foreach($result as $row) {
                    foreach($product_id as $id){
                        if($row['id_sp'] == $id){
                            ...
                            <input type="hidden" class="cart_product_id" value="<?php echo $row['id_sp']; ?>">  
                            <input type="hidden" class="cart_product_price" value="<?php echo $row['gia_sp']; ?>">  
                            <tr>
                                ...
                                <td class="price_column"><p class="item_price"><?php echo $row['gia_sp']; ?> VNĐ</p></td>
